...
class PageController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let firstChoice = page?.firstChoice {
            ...
            firstChoiceButton.addTarget(self, action: "loadFirstChoice", forControlEvents: .TouchUpInside)
        } else {
            firstChoiceButton.setTitle("Play again", forState: .Normal)
            firstChoiceButton.addTarget(self, action: "playAgain", forControlEvents: .TouchUpInside)
        }
        
        if let secondChoice = page?.secondChoice {
            secondChoiceButton.setTitle(secondChoice.title, forState: .Normal)
            secondChoiceButton.addTarget(self, action: "loadSecondChoice", forControlEvents: .TouchUpInside)
        }
    }
